...
export default function ProductDetails() {
  ...
  if (!product) return <div className="text-slate-600">No product data available.</div>;
      ...
      <div className="grid gap-8 md:grid-cols-2 md:items-start">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2 text-slate-700">
            ...
            <p><span className="font-semibold text-slate-900">Description:</span> {product.description}</p>
            <p><span className="font-semibold text-slate-900">Rating:</span> {product.rating} / 5</p>
            <p><span className="font-semibold text-slate-900">Stock Status:</span> {product.stock} items left</p>
          </div>
